...
// resource dropper (closure+24) to close the handle deterministically (RESOURCE_SAFETY.md Gap B
// deterministic close). Reaching 50 successful reads exercises the dropper path without corruption;
