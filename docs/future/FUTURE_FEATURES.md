...
| [Compiler Optimization](COMPILER_OPTIMIZATION.md) | Ongoing | LLVM passes, memory management, codegen improvements. Audit roadmap items landed: decision-tree pattern matching, compile-time string-literal interning, mutual-recursion TCO. Remaining: optional LLVM jump-table relocation support in the image linkers |
