...
internal static partial class LlvmCodegen
{
    ...
    private static bool EmitInstruction(LlvmCodegenState state, IrInst instruction, int index)
    {
        ...
        return instruction switch
        {
            ...
            IrInst.Drop drop => EmitDrop(state, LoadTemp(state, drop.SourceSlot), drop.TypeName),
            ...
            IrInst.Borrow borrow => StoreTemp(state, borrow.Target, LoadTemp(state, borrow.SourceSlot)),
