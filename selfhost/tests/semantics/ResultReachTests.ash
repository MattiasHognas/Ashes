...
let stringParameterFunction unit =
    Ashes.Text.join("\n")([
        ...
        "    LoadConstInt          Target=5 Value=1",
        "    AndInt                Target=6 Left=4 Right=5",
        "    JumpIfFalse           CondTemp=6 Target=rc_arg_normalize_copy_0",
        ...
        "    LoadLocal             Target=8 Slot=2",
        "    StoreLocal            Slot=1 Source=8",
...
let recordParameterFunction unit =
    Ashes.Text.join("\n")([
        ...
        "    GetAdtField           Target=10 Ptr=3 FieldIndex=0 Tagless=true",
        "    CopyOutArena          DestTemp=11 SrcTemp=10 RuntimeManaged=true Purpose=RcNormalization",
        "    SetAdtField           Ptr=9 FieldIndex=0 Source=11 Tagless=true",
        "    StoreLocal            Slot=2 Source=9",
        "  rc_arg_normalize_done_1:",
        "    LoadLocal             Target=12 Slot=2",
        "    StoreLocal            Slot=1 Source=12",
...
let scalarParameterFunction unit =
    Ashes.Text.join("\n")([
        ...
        "    LoadArgumentOwnership Target=3",
        "    LoadConstInt          Target=4 Value=1",
        "    ShrInt                Target=5 Left=3 Right=4",
        "    JumpIfFalse           CondTemp=5 Target=rc_result_owned_0",
        "    CopyOutList           DestTemp=6 SrcTemp=2 HeadCopy=Inline Purpose=ArenaResultBoundary",
        "    StoreLocal            Slot=3 Source=2",
        "  rcdrop_list_2:",
        "    LoadLocal             Target=7 Slot=3",
        "    LoadConstInt          Target=8 Value=0",
        "    CmpIntNe              Target=9 Left=7 Right=8",
        "    JumpIfFalse           CondTemp=9 Target=rcdrop_list_end_4",
        "    RcIsUnique            Target=10 SourceTemp=7",
        "    JumpIfFalse           CondTemp=10 Target=rcdrop_list_shared_3",
        "    LoadMemOffset         Target=11 BasePtr=7 OffsetBytes=8",
        "    RcDrop                SourceTemp=7 TypeName=List RuntimeManaged=true",
        "    StoreLocal            Slot=3 Source=11",
        "    Jump                  Target=rcdrop_list_2",
        "  rcdrop_list_shared_3:",
        "    RcDrop                SourceTemp=7 TypeName=List RuntimeManaged=true",
        "    Jump                  Target=rcdrop_list_end_4",
        "  rcdrop_list_end_4:",
        "    StoreLocal            Slot=2 Source=6",
        "    Jump                  Target=rc_result_done_1",
        "  rc_result_owned_0:",
