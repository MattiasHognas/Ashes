...
// run before and after a synchronous `Ashes.Task.run` await; every result must
...
let halves =
    given (u) ->
        match Ashes.Task.Parallel.both(given (v) -> sumRange(0)(500000)(0))(given (v) -> sumRange(500000)(1000000)(0)) with
            | (a, b) -> a + b
