...
let run unit = assertCorpus(["", "0", "18446744073709551615u64", "- -0.5", "a + b * c << 2 == d", "head :: middle :: []", "value |> map(f) |?> finish |!> recover", "Module.Submodule.binding", "f()(1, 2)([3, 4])", "Point(x = 1, y = 2)", "map transform values", "(1, \"two\", '三')", "await task(Unit)", "perform Clock.now(Unit)", "@", "(1, 2", "[1, 2", "1 2 )", "\"unterminated"])
