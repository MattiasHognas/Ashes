                            ...
                            fun (map) ->
                                match map with
                                    | Node(_height, Node(_leftHeight, leftLeft, leftKey, leftValue, leftRight), key, value, right) ->
                                        makeNode(leftLeft)(leftKey)(leftValue)(makeNode(leftRight)(key)(value)(right))
                                    | _ -> map
                        in
                            let balance =
                                fun (map) ->
                                                ...
                                                let size =
                                                    let rec go =
                                                        fun (map) ->
                                                            match map with
                                                                | Empty -> 0
                                                                | Node(_height, left, _key, _value, right) -> 1 + go(left) + go(right)
                                                    in go
                                                in
                                                    let foldLeft =
                                                        fun (folder) ->
