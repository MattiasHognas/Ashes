...
public sealed partial class Lowering
{
    ...
    private (int, TypeRef)? ResolveBytesBuiltinMember(string name, BuiltinRegistry.BuiltinValueKind kind)
    {
        return kind switch
        {
            ...
            BuiltinRegistry.BuiltinValueKind.BytesAllocate => LowerQualifiedBuiltinFunctionReference(name, CreateBytesAllocateBinding().S.Body),
            BuiltinRegistry.BuiltinValueKind.BytesCopyRange => LowerQualifiedBuiltinFunctionReference(name, CreateBytesCopyRangeBinding().S.Body),
            BuiltinRegistry.BuiltinValueKind.BytesSet => LowerQualifiedBuiltinFunctionReference(name, CreateBytesSetBinding().S.Body),
            BuiltinRegistry.BuiltinValueKind.BytesSetU16Le => LowerQualifiedBuiltinFunctionReference(name, CreateBytesSetU16LeBinding().S.Body),
            BuiltinRegistry.BuiltinValueKind.BytesSetU32Le => LowerQualifiedBuiltinFunctionReference(name, CreateBytesSetU32LeBinding().S.Body),
            BuiltinRegistry.BuiltinValueKind.BytesSetU64Le => LowerQualifiedBuiltinFunctionReference(name, CreateBytesSetU64LeBinding().S.Body),
