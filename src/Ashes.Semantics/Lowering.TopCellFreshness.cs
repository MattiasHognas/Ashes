...
public sealed partial class Lowering
{
    ...
    /// <see cref="IsArenaSelfContainedListRebuildExpr"/> deliberately does, for a different risk profile — a
    ...
    /// a per-arm freshness predicate and a per-arm grouping key, preserving the PR #299 invariant:
