...
| Semantics | Stable symbols and lexical scopes; source type resolution for primitives, parameters, nominal applications, functions, tuples, pointers, and capability rows; semantic substitutions, unification, constrained schemes; annotation-aware Algorithm W inference for core expressions, operators, and guarded matches including constructor, record, alias, and or-patterns; and sequential whole-program inference with polymorphic ADT constructor registration |
