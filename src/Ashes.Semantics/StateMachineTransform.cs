...
public static class StateMachineTransform
{
    ...
    private static IEnumerable<int> GetDefinedTempsAllocFileText(IrInst inst)
    {
        return inst switch
        {
            ...
            IrInst.CopyFfiBytes i => [i.Target],
            ...
            IrInst.FileReplace i => [i.Target],
            IrInst.FileMakeExecutable i => [i.Target],
            IrInst.DirectoryEntries i => [i.Target],
            IrInst.DirectoryCreateAll i => [i.Target],
            IrInst.DirectoryRemoveTree i => [i.Target],
            IrInst.EnvironmentDirectory i => [i.Target],
            IrInst.EnvironmentGet i => [i.Target],
            ...
            IrInst.TextUnconsText i => [i.Target],
            IrInst.RuneToText i => [i.Target],
            IrInst.RuneFromInt i => [i.Target],
    ...
    private static IEnumerable<int> GetDefinedTempsNetAndBytes(IrInst inst)
    {
        return inst switch
        {
            ...
            IrInst.BytesAllocate i => [i.Target],
            IrInst.BytesCopyRange i => [i.Target],
            IrInst.BytesSet i => [i.Target],
            IrInst.BytesSetU16Le i => [i.Target],
            IrInst.BytesSetU32Le i => [i.Target],
            IrInst.BytesSetU64Le i => [i.Target],
    ...
    private static IEnumerable<int> GetDefinedTempsTaskAndParallel(IrInst inst)
    {
        return inst switch
        {
            ...
            IrInst.IsReferenceCounted i => [i.Target],
    ...
    private static IEnumerable<int> GetUsedTempsAdtFileText(IrInst inst)
    {
        return inst switch
        {
            ...
            IrInst.CopyFfiBytes copy => [copy.PointerTemp, copy.LengthTemp],
            ...
            IrInst.FileReplace f => [f.SourceTemp, f.DestinationTemp],
            IrInst.FileMakeExecutable f => [f.PathTemp],
            IrInst.DirectoryEntries d => [d.PathTemp],
            IrInst.DirectoryCreateAll d => [d.PathTemp],
            IrInst.DirectoryRemoveTree d => [d.PathTemp],
            IrInst.EnvironmentGet e => [e.NameTemp],
            ...
            IrInst.TextUnconsText t => [t.TextTemp],
            IrInst.RuneToText t => [t.RuneTemp],
            IrInst.RuneFromInt t => [t.IntTemp],
    ...
    private static IEnumerable<int> GetUsedTempsNetAndBytes(IrInst inst)
    {
        return inst switch
        {
            ...
            IrInst.BytesAllocate i => [i.LengthTemp],
            IrInst.BytesCopyRange i => [i.BytesTemp, i.OffsetTemp, i.SourceTemp, i.SourceOffsetTemp, i.LengthTemp],
            IrInst.BytesSet i => [i.BytesTemp, i.OffsetTemp, i.ValueTemp],
            IrInst.BytesSetU16Le i => [i.BytesTemp, i.OffsetTemp, i.ValueTemp],
            IrInst.BytesSetU32Le i => [i.BytesTemp, i.OffsetTemp, i.ValueTemp],
            IrInst.BytesSetU64Le i => [i.BytesTemp, i.OffsetTemp, i.ValueTemp],
    ...
    private static IEnumerable<int> GetUsedTempsTaskAndParallel(IrInst inst)
    {
        return inst switch
        {
            ...
            IrInst.IsReferenceCounted t => [t.SourceTemp],
