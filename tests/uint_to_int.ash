...
// Ashes.Number.UInt.toInt widens an unsigned integer (u8/u16/u32/u64) to a signed Int, so a byte read with
// Ashes.Byte.get can be used in Int arithmetic directly -- enabling byte-level integer parsing without
