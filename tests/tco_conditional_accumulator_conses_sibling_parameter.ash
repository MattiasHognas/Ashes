// A conditional accumulator that conses a sibling loop parameter is not placed on the
// reference-counted heap: the back edge releases that parameter's predecessor, which the
// accumulator would be left holding. It stays in the arena and the result is unchanged.
// expect: 525
