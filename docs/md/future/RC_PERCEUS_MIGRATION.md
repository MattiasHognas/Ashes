...
allocation-free Bytes input and copy-valued byte. Allocating append operands and list-conversion escapes
remain on the arena path until nested producer ownership is carried with them.
