...
| Frontend | Source tokens, UTF-8 spans, lexical diagnostics, the complete lexer, the typed AST model, inline-module lifting and restricted-body validation, expression/pattern/type parsing, and whole-program parsing for every current declaration form and trailing bodies; versioned token-stream parity against stage 0 |
