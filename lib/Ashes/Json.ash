    ...
    fun (text) ->
        match Ashes.Text.uncons(text) with
            ...
            | Some((h, t)) ->
                ...
                else if h == "\r" then skipWs(t)
                else if h == "\t" then skipWs(t)
                else text
in
                        ...
                        | Some((h, t)) ->
                            ...
                            then
                                match Ashes.Text.uncons(t) with
                                    ...
                                    | Some((esc, t2)) ->
                                        if esc == "\"" then parseStrBody(acc + "\"")(t2)
                                        else if esc == "\\" then parseStrBody(acc + "\\")(t2)
                                        else if esc == "/" then parseStrBody(acc + "/")(t2)
                                        else if esc == "n" then parseStrBody(acc + "\n")(t2)
                                        else if esc == "r" then parseStrBody(acc + "\r")(t2)
                                        else if esc == "t" then parseStrBody(acc + "\t")(t2)
                                        else if esc == "b" then parseStrBody(acc + "\n")(t2)
                                        else if esc == "f" then parseStrBody(acc + "\t")(t2)
                                                                                                                ...
                                                                                                                | Some((sep, sepTail)) ->
                                                                                                                    ...
                                                                                                                    then
                                                                                                                        match parseObj(sepTail) with
                                                                                                                            | Error(e) -> Error(e)
                                                                                                                            | Ok((rObj, rAfter)) ->
                                                                                                                                Ok((JsonObject(key)(v)(rObj), rAfter))
                    ...
                    fun (acc) ->
                        fun (text) ->
                            match Ashes.Text.uncons(text) with
                                | None -> acc
                                | Some((h, t)) ->
                                    if h == "\"" then escStr(acc + "\\\"")(t)
                                    else if h == "\\" then escStr(acc + "\\\\")(t)
                                    else if h == "\n" then escStr(acc + "\\n")(t)
                                    else if h == "\r" then escStr(acc + "\\r")(t)
                                    else if h == "\t" then escStr(acc + "\\t")(t)
                                    else escStr(acc + h)(t)
                in
                    let rec stringify =
                                ...
                                let rec strObj =
                                    fun (rest) ->
                                        match rest with
                                            | JsonObjectEnd -> ""
                                            | JsonObject(k, v, nr) ->
                                                ",\"" + escStr("")(k) + "\":" + stringify(v) + strObj(nr)
                                            | _ -> ""
                                in
                                    match json with
                                        | JsonNull -> "null"
                                        ...
                                        | JsonObjectEnd -> "{}"
                                        | JsonObject(key, v, rest) ->
                                            "{\"" + escStr("")(key) + "\":" + stringify(v) + strObj(rest) + "}"
                    in
                        let get =
                            fun (key) ->
                                fun (json) ->
                                    let rec go =
                                        fun (cur) ->
                                            match cur with
                                                ...
                                                | JsonObject(k, v, rest) ->
                                                    if k == key then Ok(v) else go(rest)
                                                                ...
                                                                fun (cur) ->
                                                                    fun (idx) ->
                                                                        match cur with
                                                                            ...
                                                                            | JsonArray(elem, rest) ->
                                                                                if idx <= 0 then Ok(elem) else go(rest)(idx - 1)
