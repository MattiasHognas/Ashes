...
- [~] Plan hidden trait dictionary parameters, method fields, specialized direct-supertrait fields,
  ...
  arity/remaining-argument evidence capture for constrained partial applications. Thread those
  dictionaries through functions, closures, recursive calls, aggregates, and async frames.
