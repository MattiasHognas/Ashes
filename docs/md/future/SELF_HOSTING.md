...
- [~] Plan hidden trait dictionary parameters, method fields, specialized direct-supertrait fields,
  ...
  method bindings. Rewrite constrained calls and physically thread dictionaries through the
  corresponding lowered representations.
