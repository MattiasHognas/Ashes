...
| Semantics | Stable symbols and lexical scopes plus the semantic type algebra, substitutions and unification, environment-aware schemes, and Algorithm W inference for literals, qualified variables, lambdas, application, polymorphic and recursive lets, tuples, lists, cons, and conditionals |
