...
| Semantics | Stable symbols and lexical scopes; source type resolution for primitives, parameters, nominal applications, functions, tuples, pointers, and capability rows; semantic substitutions, unification, constrained schemes; and annotation-aware Algorithm W inference for core expressions, trait-constrained operators, and guarded matches over literal, binding, alias, list, and tuple patterns |
