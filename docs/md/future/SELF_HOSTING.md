...
- [~] Plan hidden trait dictionary parameters, method fields, specialized direct-supertrait fields,
  ...
  closure captures, nested aggregate locations, and async frames. Rewrite values and physically thread
  those dictionaries through the corresponding lowered representations.
