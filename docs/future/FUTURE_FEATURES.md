...
| [HTTPS/TLS](HTTPS_TLS.md) | Partial | Transparent `https://` in `Ashes.Http` landed on Linux x64, Linux arm64, and Windows x64 via OpenSSL 3; built-in hermetic TLS is the chosen long-term direction and raw TLS follow-on work remains |
