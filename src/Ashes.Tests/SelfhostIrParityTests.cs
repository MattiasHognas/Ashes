...
public sealed class SelfhostIrParityTests
{
    ...
    [Arguments("producer_conses_nested_variant_head")]
    [Arguments("user_type_named_function_release")]
    [Arguments("passthrough_or_fresh_result")]
    [Arguments("tco_parameter_kept_by_borrowing_callee_result")]
    [Arguments("record_update_successor_of_loop_parameter")]
    ...
    [Arguments("owned_value_released_behind_optional_scalar_result")]
    ...
    [Arguments("fresh_argument_released_behind_unproven_result")]
    ...
    [Arguments("list_literal_static_and_computed_heads")]
    [Arguments("concat_runtime_result")]
    [Arguments("curried_known_call_result")]
    [Arguments("generic_list_result_deep_copy")]
    [Arguments("handle_match_arm_reset")]
    [Arguments("lambda_returns_record")]
    [Arguments("parameter_reaches_result_record")]
    [Arguments("parameter_reaches_result_string")]
