...
[self-hosting log](SELF_HOSTING_LOG.md). The capability audit of what the language, compiler and
standard library must provide before a compiler can be written in Ashes is at the end, under
