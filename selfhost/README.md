...
| Formatter | Canonical whole-program, declaration, expression, pattern, and type rendering with precedence preservation and idempotence coverage; whole-file formatting that keeps the leading comment block, re-renders the import header canonically, and reinserts standalone comments at their token-signature anchors |
