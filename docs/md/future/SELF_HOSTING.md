...
- [~] Plan hidden trait dictionary parameters, method fields, specialized direct-supertrait fields,
  ...
  inherited active-dictionary forwarding across recursive and sibling call edges. Thread those
