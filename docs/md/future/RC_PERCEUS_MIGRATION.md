...
string concatenations and migrated Byte producer results, affine `ConcatStrTip` accumulators,
literals, views, other builtin-produced strings and Bytes values, and BigInts remain arena-managed.
