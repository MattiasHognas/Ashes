// A loop whose exit builds a pair holding its accumulator of records while its other arm jumps back:
// the pair is fresh, and the function's return takes it over rather than retaining it again.
// expect: 40000
type Tok =
    | kind: Int
    | text: Str
