...
|---|---|
| Frontend | Source tokens, UTF-8 spans, lexical diagnostics, the complete lexer, the typed AST model, and expression parsing through control forms and patterns |
