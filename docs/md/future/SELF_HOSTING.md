...
- [~] Register the shipped standard trait ABI and primitive/structural implementation heads, including
  recursive evidence requirements and stable compiler-private implementation references. Bind those
  references to the actual `Ashes.Trait` source bodies during module stitching.
